...
class OSCheck:
  ...
  @staticmethod
  def is_opensuse_family():
    """
     Return true if it is so or false if not

     This is safe check for opensuse family, doesn't generate exception
    """
    return OSCheck.is_in_family(OSCheck.get_os_family(), OSConst.OPENSUSE_FAMILY)
