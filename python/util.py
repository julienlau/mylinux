...
def sizeof(obj):
    """Estimates total memory usage of (possibly nested) `obj` by recursively calling sys.getsizeof()
       and adding up the results. Handle custom object types. Handle circular object references.
    """
    memory_size = 0
    ids = set()
    objects = [input_obj]
