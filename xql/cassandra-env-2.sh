...
calculate_heap_sizes()
{
    ...
    # calculate 1/4 ram and cap to 16384MB
    # pick the max
    ...
    if [ "$quarter_system_memory_in_mb" -gt "16384" ]
    then
        quarter_system_memory_in_mb="16384"
    fi
...
## JVM_OPTS="$JVM_OPTS -javaagent:/opt/jmx_exporter/jmx_prometheus_javaagent-0.12.0.jar=9101:/opt/jmx_exporter/config.yml"
